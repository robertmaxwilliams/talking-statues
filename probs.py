...
def single_tokie(*, hparams, length, start_token=None, batch_size=None, context=None):
    if start_token is None:
        assert context is not None, "Specify exactly one of start_token and context!"
    else:
        assert context is None, "Specify exactly one of start_token and context!"
...
def generate2(
    ...
    f_me = sess.run(logis, feed_dict={context: batch_size * [context_tokens]})[0]
...
output = generate2(
    sess,
    prefix="The cat is the horse of this country",
